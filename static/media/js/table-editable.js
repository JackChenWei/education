    ...
    return {
        ...
        init: function () {
            ...
            function saveRow(oTable, nRow) {
                ...
                oTable.fnUpdate('<a class="edit" href="">修改</a>', nRow, 8, false);
            ...
            $('#system_user_manage_add_button').click(function (e){
                e.preventDefault();
                window.location.href = "/system_user_manage_add"
            });
            ...
            $('#sample_editable_1 a.delete').live('click', function (e) {
                ...
                var Account = document.getElementById('user_Account').textContent;
                var nRow = $(this).parents('tr')[0];

                $.ajax({
                    type : "POST",
                    url  : "/system_user_manage_delete/",
                    data : {
                        'Account':Account
                    },
                    dataType : 'json',
